...
//                    userId: '.isMine'
                ...
                $('#basic-search').val('');
                const seTerms = store.get('search_term') || {};
                const fiTerms = store.get('filters') || {};
                ...
                if(postData.request) {
                    ...
                    postCollection.getAllPosts(postData, query.force || isForce, function(err, posts) {
                        if (posts !== undefined) {
                            ...
                            var elem = document.querySelector('.page-cont');
                            masonElement = new Masonry( elem, { itemSelector: '.elem-cont',
                                  isAnimated: true});
                                /*$('.page-cont').masonry({
