(function (global, factory) {
  ...
  typeof define === 'function' && define.amd ? define('wasm-imagemagick', ['exports'], factory) :
          ...
          return __generator(this, function (_a) {
              switch (_a.label) {
                  ...
                  case 2:
                      ...
                      if (result.exitCode) {
                          return [2 /*return*/, _assign({}, result, { errors: ['exit code: ' + result.exitCode + ' stderr: ' + result.stderr.join('\n')] })];
                      }
                      return [2 /*return*/, _assign({}, result, { errors: [undefined] })];
                  case 3:
                      error_1 = _a.sent();
                      return [2 /*return*/, _assign({}, result, { errors: [error_1 + ', exit code: ' + result.exitCode + ', stderr: ' + result.stderr.join('\n')] })];
          ...
          return __awaiter(this, void 0, void 0, function () {
              ...
              return __generator(this, function (_a) {
                  switch (_a.label) {
                      ...
                      case 1:
                          inputFiles = _a.sent();
                          return [4 /*yield*/, execute$$1(_assign({}, config, { inputFiles: inputFiles }))];
                      case 2:
                          result = _a.sent();
...
//# sourceMappingURL=wasm-imagemagick.umd-es5.js.map
