    ...
    const del = function (url, callback) {
        $.ajax({
            url: url, 
            method: 'DELETE',
            dataType: 'JSON',
    ...
    const postImage = function (url, postdata,  callback) {
        $.ajax({
            url: url, 
            method: 'POST',
            data: postdata,
    ...
    const putImage = function (url, postData, callback) {
        $.ajax({
            url: url, 
            method: 'PUT',
            data: postData,
    ...
    const put = function (url, postdata, callback) {
        if (postdata) {       
